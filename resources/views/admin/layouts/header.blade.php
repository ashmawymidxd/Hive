...
<header class="main-header">
    ...
    <div class="col-md-4 btn-group border shadow-0 d-none d-md-flex">
        ...
        <input id="search-input" type="search" class="form-control border-0" placeholder="Search at any table..." aria-label="Search">
    </div>
        ...
        <div class="notification-dropdown mx-2 position-relative">
            ...
            <div class="dropdown profile-dropdown">
                <button class="btn btn-primary rounded-circle p-2 bg-navy text-white shadow-0" type="button"
                    ...
                    @auth
                        @php
                            $admin = explode(' ', Auth::user('admin')->name);
                        @endphp
                        {{ substr($admin[0], 0, 1) }}{{ substr($admin[1], 0, 1) }}
                    @else
                        GU
                    @endauth
                </button>
